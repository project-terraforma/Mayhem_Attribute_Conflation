...
This directory contains detailed documentation, reports, and summaries related to the Mayhem Attribute Conflation project.
...
*   [AI Annotation Report](docs/AI_ANNOTATION_REPORT.md)
*   [Quick Start AI Guide](docs/QUICK_START_AI.md)
*   [Varnit's Updates (ML Pipeline)](docs/var_updates.md)
*   [Data Exploration Report](docs/data_exploration_report.md)
*   [Annotations Format](docs/annotations_format.md)

---

## Detailed OKRs and Progress
